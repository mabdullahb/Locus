...
export function HistoryPanel() {
  ...
  }, [extractionStatus, config?.enrichmentDepth, addSession]);
  ...
  // Was previously a no-op navigate that ignored the session entirely —
  // "Re-run with same config" didn't actually carry any config anywhere.
  const handleReRun = (session: HistorySession) => {
    closePanel();
    router.push(
      buildRerunUrl({
